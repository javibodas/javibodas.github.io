...
class ArticlesList extends React.Component {
  constructor(props) {
    ...
    this.data = JSON.parse('[{"year":"2020", "months":[{"month": "Febrero","articles":[{"title":"Aplicaciones Descentralizadas. Instalación y configuración", "link":"https:javibodas.github.io/public/posts/configuracion-dapp.html"}]},{"month": "Marzo", "articles":[{"title":"Aplicación Spring Boot en Heroku. Instalación y Configuración","link":"https:javibodas.github.io/public/posts/iniciar-proyecto-spring-y-heroku.html"}]}]}]');
